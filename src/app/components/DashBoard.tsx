...
export async function Dashboard({component}: Props) {
    ...
    let deprecationCard = <DbCard title={metrics.numberOfDeprecations.title} history={deprecationHistoryFormatted}
                                  ...
                                  currentValue={numberOfDeprecationTS} component={component}
    ...
    if (data.measures) {
        grid = <Grid numItemsSm={2} numItemsLg={3} className="gap-6">
            <SonarQubeCard title={metrics.codeCoverage.title} history={measures[0].history}
                           isIncreasePositive={metrics.codeCoverage.isIncreasePositive}
                           formattingType={metrics.codeCoverage.formatting}/>
            <SonarQubeCard title={metrics.cognitiveComplexity.title} history={measures[1].history}
                           isIncreasePositive={metrics.cognitiveComplexity.isIncreasePositive}
                           formattingType={metrics.cognitiveComplexity.formatting}/>
            <SonarQubeCard title={metrics.technicalDebt.title} history={measures[2].history}
        ...
        grid = <Grid numItemsSm={2} numItemsLg={3} className="gap-6">
            <SonarQubeCard title={metrics.codeCoverage.title}
                           isIncreasePositive={metrics.codeCoverage.isIncreasePositive}
                           formattingType={metrics.codeCoverage.formatting}/>
            <SonarQubeCard title={metrics.cognitiveComplexity.title}
                           isIncreasePositive={metrics.cognitiveComplexity.isIncreasePositive}
                           formattingType={metrics.cognitiveComplexity.formatting}/>
            <SonarQubeCard title={metrics.technicalDebt.title}
                           isIncreasePositive={metrics.technicalDebt.isIncreasePositive}
                           formattingType={metrics.technicalDebt.formatting}/>
            {deprecationCard}
        </Grid>
